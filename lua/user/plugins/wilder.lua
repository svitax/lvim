...
M.config = function()
  ...
  vim.keymap.set("c", "<Tab>", "<cmd>lua require('wilder').next()<cr>", { noremap = true })
  vim.keymap.set("c", "<S-Tab>", "<cmd>lua require('wilder').previous()<cr>", { noremap = true })
  vim.keymap.set("c", "<C-j>", "<cmd>lua require('wilder').next()<cr>", { noremap = true })
  vim.keymap.set("c", "<C-k>", "<cmd>lua require('wilder').previous()<cr>", { noremap = true })
